...
public class ServerNotifyClientPacket implements Packet {
	...
	public ServerNotifyClientPacket(ClientNotification notification,
	...
	public void read(NetInput in) throws IOException {
		this.notification = MagicValues.key(ClientNotification.class,
				in.readUnsignedByte());
	...
	public void write(NetOutput out) throws IOException {
		...
		if (this.value instanceof GameMode) {
			value = (float) MagicValues.value(Integer.class,
					(Enum<?>) this.value);
		}
